...
var ASM_CONSTS = [function($0, $1, $2) { onframe($0, $1, $2); }];

function _emscripten_asm_const_iiij(code, a0, a1, a2) {
...
var real__read_buffer = asm["_read_buffer"]; asm["_read_buffer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__read_buffer.apply(null, arguments);
};
...
var _read_buffer = Module["_read_buffer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_read_buffer"].apply(null, arguments) };
